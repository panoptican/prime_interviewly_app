...
router.get('/test', function(req, res, next){
  var students = [
    ...
    {name: "Kathryn", scheduled: {with:{}, count:{total: 0}}},
  ...
  var interviewers = [
    {name: "name", company: "Versique", scheduled: {}, unavailable: {}, id: 0, breaks: 0},
    {name: "name", company: "TPS", scheduled: {}, unavailable: {}, id: 1, breaks: 0},
    {name: "Jacqui", company: "ICS", scheduled: {}, unavailable: {}, id: 2, breaks: 0},
    {name: "Nichole", company: "ICS", scheduled: {}, unavailable: {}, id: 3, breaks: 0},
    {name: "Sean", company: "ICS", scheduled: {}, unavailable: {}, id: 4, breaks: 0},
    {name: "name", company: "The Creative Group", scheduled: {}, unavailable: {}, id: 5, breaks: 0},
    ...
    {name: "Bryan", company: "Digital People", scheduled: {}, unavailable: {}, id: 13, breaks: 0},
    {name: "Megan", company: "Experis", scheduled: {}, unavailable: {}, id: 14, breaks: 0},
    {name: "Dana", company: "Experis", scheduled: {}, unavailable: {}, id: 15, breaks: 0},
    {name: "name", company: "Azule Staffing", scheduled: {}, unavailable: {slot8: true, slot9: true}, id: 16, breaks: 0}
  ];

  Tools.combine(interviewers, students, function(combinations){
    Tools.schedule(9, interviewers, students, combinations, 8, 2, function(schedule){
      res.json(schedule);
    })
  })
